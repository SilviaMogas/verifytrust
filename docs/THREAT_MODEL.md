...
| Open demo endpoints | Unauthenticated demo issuer or relayer access could be abused in production. | The issuer and relayer endpoints are intentionally open for this demo; the issuer endpoint represents the fictional merchant. | Production requires merchant-authenticated issuance and relayer authentication and rate limiting. |
